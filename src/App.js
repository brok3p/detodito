      ...
      <section className="section-container">
        <div class="col-xl-9">
          <div class="card-columns">
            <div class="card">
              <a href="#">
                <img class="img-fluid" src="assets/img/bg1.jpg" />
              </a>
              <div class="card-body">
                <p class="d-flex">
                  <span>
            ...
            <div class="card">
              <a href="#">
                <img class="img-fluid" src="assets/img/bg10.jpg" />
              </a>
              <div class="card-body">
                <p class="d-flex">
                  <span>
                ...
                <p>Nullam posuere euismod volutpat. Quisque in ligula eget libero tristique varius sed euismod
                  dolor. Sed ultrices, diam varius pellentesque porta, nulla neque auctor elit, quis tempus orci
                  massa eget odio. Duis eleifend elementum commodo. Donec volutpat tristique laoreet. Cras vitae
                  turpis enim, eget malesuada erat. Suspendisse quam leo, gravida a ullamcorper a, interdum id
                  odio. Nullam eu lacus in nibh rutrum ornare at eget tellus.</p>
              </div>
            </div>
            <div class="card">
              <a href="#">
                <img class="img-fluid" src="assets/img/bg2.jpg" />
              </a>
              <div class="card-body">
                <p class="d-flex">
                  <span>
            ...
            <div class="card">
              <a href="#">
                <img class="img-fluid" src="assets/img/bg8.jpg" />
              </a>
              <div class="card-body">
                <p class="d-flex">
                  <span>
                ...
                <p>Aenean iaculis diam lectus. Morbi quis purus velit. Maecenas tincidunt tempus sapien id ultrices.
                  Vivamus fermentum libero vel felis aliquet interdum.</p>
              </div>
            </div>
            <div class="card">
              <a href="#">
                <img class="img-fluid" src="assets/img/bg3.jpg" />
              </a>
              <div class="card-body">
                <p class="d-flex">
                  <span>
            ...
            <div class="card">
              <a href="#">
                <img class="img-fluid" src="assets/img/bg4.jpg" />
              </a>
              <div class="card-body">
                <p class="d-flex">
                  <span>
            ...
            <div class="card">
              <a href="#">
                <img class="img-fluid" src="assets/img/bg5.jpg" />
              </a>
              <div class="card-body">
                <p class="d-flex">
                  <span>
            ...
            <div class="col-4 col-xl-12">
              <div class="card card-default">
                ...
                <div class="card-body ie-fix-flex">
                  <a href="">
                    <img class="img-fluid img-thumbnail" src="assets/img/mockup.png" />
                  </a>
                </div>
              </div>
            </div>
